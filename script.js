...
kleur.push('Geel');
kleur.push(5);
kleur.push("hi ik ben een object");
...
console.log("Naam kattenras 1:", catBreeds[0].name);
console.log("Energielevel kattenras 1:", catBreeds[0].energy_level);
